...
MEC= mecdynamics.o mecevent.o mecevent_tem.o mecevent_Nieves.o mecevent_SuSA.o\
     mecevent_common.o e_el_event.o e_el_sigma.o mecdynamics2.o mecevent2.o   
...
$(BIN)/nuwro:   $(addprefix src/,\
        pauli.o cohevent2.o cohdynamics2.o qelevent1.o hypevent.o hyperon_interaction.o hyperon_cascade.o e_el_event.o e_el_sigma.o\
...
$(BIN)/ganalysis: $(addprefix src/, \
		event1.o event1Dict.o generatormt.o particle.o pauli.o cohevent2.o cohdynamics2.o qelevent1.o mecdynamics.o mecevent.o hypevent.o hyperon_interaction.o hyperon_cascade.o\
...
$(BIN)/reweight_to: $(addprefix src/, \
		nuwro.o pauli.o cohevent2.o cohdynamics2.o qelevent1.o hypevent.o hyperon_interaction.o hyperon_cascade.o e_el_event.o e_el_sigma.o sfevent.o\
